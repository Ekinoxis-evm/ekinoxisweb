      ...
      <div className="min-h-screen py-12 md:py-24 px-6">
        <div className="max-w-screen-2xl mx-auto">
          ...
          <motion.div
            ...
            className="bg-primary px-6 md:px-10 py-6 mb-px flex flex-col sm:flex-row sm:items-center justify-between gap-4 overflow-hidden"
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-primary/10">
              {universities.map((partner, idx) => (
                <motion.div
                  ...
                  className="relative bg-surface-container-low p-6 md:p-10 flex flex-col items-center justify-center group hover:bg-surface-container transition-colors duration-500 min-h-[180px]"
                >
