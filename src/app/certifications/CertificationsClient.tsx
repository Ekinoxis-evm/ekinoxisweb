          ...
          >
            {partners.map((partner, idx) => (
              <motion.div
                key={partner.id}
                variants={fadeInUp}
                className="relative bg-surface-container-low p-8 md:p-12 flex flex-col items-center group hover:bg-surface-container transition-colors duration-500 min-h-[280px]"
              >
                {/* UID */}
